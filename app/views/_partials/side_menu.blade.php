...
<div id="side-menu" class="pushy pushy-left">
	...
	<ul class="menu">
		<li><a href="{{ route('home.show') }}#latest-games" class="menu-games menu-btn"><span>{{ trans('global.games') }}</span></a></li>
		<li><a href="{{ route('home.show') }}#news" class="menu-news menu-btn"><span>{{ trans('global.news') }}</span></a></li>
		<li><a href="{{ route('home.show') }}#faqs" class="menu-faqs menu-btn"><span>{{ trans('global.faqs') }}</span></a></li>
		<li><a href="{{ route('home.show') }}#contact" class="menu-contact menu-btn"><span>{{ trans('global.contact') }}</span></a></li>
	</ul>
	...
	<ul class="social">
		...
		<li><a href="mailto:{{ $site_variables[6]->variable_value }}" class="support"><i class="fa fa-heart"></i> <span>support@tdrive.co</span></a></li>
	</ul>
