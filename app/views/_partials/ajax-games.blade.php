	...
	@foreach ($game->apps as $app)
			...
			<div class="item">
				<div class="thumb relative">
					<a href="{{ URL::route('game.show', array('id' => $app->pivot->game_id, $app->pivot->app_id)) }}" class="thumb-image"><img src="{{ URL::to('/') }}/assets/games/icons/{{ Media::getGameIcon($app->pivot->game_id) }}" alt="{{ $app->pivot->title }}"></a>
